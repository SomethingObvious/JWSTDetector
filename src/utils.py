...
def get_dataset_info(dataset, preprocess, data_path=None):
    ...
    if dataset == "JWST":
        objects = ["object1"]  # must match your folder name under datasets/jwst_custom/
        objectanomalies = {"object1": ["anomaly"]}   # or list anomaly subfolders under test/, excluding "good"
        maskingdefault = {"object1": False}
        rotationdefault = {"object1": False}
        return objects, objectanomalies, maskingdefault, rotationdefault
